...
let e = {
    ...
    if (!c[d]) {
        let t = u !== e ? e : ((e)=>{
            ...
            for(; t = goober_modern_l.exec(e.replace(a, ""));)t[4] ? o.shift() : t[3] ? (r = t[3].replace(n, " ").trim(), o.unshift(o[0][r] = o[0][r] || {})) : o[0][t[1]] = t[2].replace(n, " ").trim();
            return o[0];
        })(e);
        c[d] = o(p ? {
            ["@keyframes " + d]: t
...
let d, goober_modern_f, g, b = u.bind({
    g: 1
}), h = u.bind({
    k: 1
});
function m(e, t, r, l) {
    o.p = t, d = e, goober_modern_f = r, g = l;
}
...
`, M = ({ toast: e })=>{
    ...
    return t !== void 0 ? typeof t == "string" ? /*#__PURE__*/ y.createElement(fe, null, t) : t : o === "blank" ? null : /*#__PURE__*/ y.createElement(le, null, /*#__PURE__*/ y.createElement(V, {
        ...s
    }), o !== "loading" && /*#__PURE__*/ y.createElement(ue, null, o === "error" ? /*#__PURE__*/ y.createElement(_, {
        ...s
...
`, Ae = (e, t)=>{
    ...
    return {
        animation: t ? `${z(a)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards` : `${z(r)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`
    };
}, F = /*#__PURE__*/ (/* unused pure expression or super */ null && (l.memo(({ toast: e, position: t, style: o, children: s })=>{
    let a = e.height ? Ae(e.position || t || "top-center", e.visible) : {
        opacity: 0
    }, r = /*#__PURE__*/ l.createElement(M, {
        toast: e
    }), c = /*#__PURE__*/ l.createElement(Se, {
        ...e.ariaProps
    }, T(e.message, e));
    return /*#__PURE__*/ l.createElement(be, {
        ...
        icon: r,
        message: c
    }) : /*#__PURE__*/ l.createElement(l.Fragment, null, r, c));
})));
...
`, O = 16, Ie = ({ reverseOrder: e, position: t = "top-center", toastOptions: o, gutter: s, children: a, containerStyle: r, containerClassName: c })=>{
    ...
    return /*#__PURE__*/ f.createElement("div", {
        ...
        return /*#__PURE__*/ f.createElement(Ee, {
            ...
            style: x
        }, p.type === "custom" ? T(p.message, p) : a ? a(p) : /*#__PURE__*/ f.createElement(F, {
            toast: p,
            position: g
        }));
    }));
...
function helpers_getEnvVariable(key) {
...
function getErrorResponse(status = 500, message, errors = null) {
...
const signJWT = async (payload, options)=>{
    try {
        ...
        return new SignJWT(payload).setProtectedHeader({
            alg
        }).setExpirationTime(options.exp).setIssuedAt().setSubject(payload.sub).sign(secret);
    } catch (error) {
        throw error;
    }
};
const verifyJWT = async (token)=>{
    try {
        return (await jwtVerify(token, new TextEncoder().encode(process.env.JWT_SECRET_KEY))).payload;
    } catch (error) {
        console.log(error);
...
