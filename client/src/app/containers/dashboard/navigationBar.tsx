...
const profileSettings = [
  ...
  { name: "Rewards", route: "/rewards" },
  {
    ...
    route: "https://billing.stripe.com/p/login/test_cN23e27JRdQPeMEbII",
  },
...
function ResponsiveAppBar() {
  ...
  const Logo = () => {
    const logoUrl =
      "https://drive.google.com/uc?export=view&id=1gF49xuN0t0yjIv7WoybLhTScP6b15-fJ"; // Direct link
    return (
      <img
        src={logoUrl}
        alt="Box Office Logo"
          ...
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" } }}>
              ...
              >
                {pages.map((page) => {
                  if (
                    page.route !== "openModal" ||
                    (page.route === "openModal" && store.isAdmin)
                  ) {
                    return (
