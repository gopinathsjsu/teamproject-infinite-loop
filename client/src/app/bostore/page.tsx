...
export default function HomePage() {
  ...
  const images = ['https://scontent-sjc3-1.xx.fbcdn.net/v/t1.6435-9/46282568_1008297862711032_2827960145911218176_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=7f8c78&_nc_ohc=EISr4vn0HVIAX9fupq4&_nc_ht=scontent-sjc3-1.xx&oh=00_AfBfOOydZXeKGhcabHrGhyRvyhlpuP3WeaZ0rP0682wBUg&oe=658F2581','https://scontent-sjc3-1.xx.fbcdn.net/v/t1.6435-9/175348669_10159307436625396_1528083320368309883_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=c2f564&_nc_ohc=F9fsg97iykEAX8qqOmj&_nc_ht=scontent-sjc3-1.xx&oh=00_AfCx9EyWaPIMao5R5YUTRUczsk0yHSNPeWql4Km5JOjgyA&oe=658F2DDB'];
  ...
  return (
    <Container maxWidth="lg">
      ...
      <Card sx={{ position: 'fixed', top: 80, right: 20, padding: 2, width: 300, boxShadow: 4 }}>
        ...
        <Button variant="contained" color="success" fullWidth>Checkout</Button>
      </Card>
    </Container>
  );
}
